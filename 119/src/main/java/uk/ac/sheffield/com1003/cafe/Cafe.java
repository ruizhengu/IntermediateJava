...
public class Cafe {
    ...
    public void printPendingOrders() {
        ...
        // The pending orders refer to the difference between two indexes
    ...
    public void printMenu() {
      ...
      for (Recipe recipe : menu)
        if (recipe != null)
          System.out.printf("%s - %.1f%n", recipe.getName(), recipe.getPrice());
      System.out.println("==========");
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        // Determine whether the amount paid by the customer is sufficient
    ...
    public Order serveOrder() throws CafeOutOfCapacityException {
        ...
        // If there are pending orders exsit. Serve the first one and return
