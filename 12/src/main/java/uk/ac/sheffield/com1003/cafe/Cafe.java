...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        for (Recipe recipe : menu) {
            if (findRecipe(recipeName) != null && recipe.getName().equals(recipeName)) {
                recipe = null;
            } else {
    ...
    public void printMenu() {
        ...
        // avoiding invoking the method on nulls or empty
        Recipe[] cleanMenu = getMenu();

        for (Recipe recipe : cleanMenu) {   
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        Recipe recipeToFind = findRecipe(recipeName);
        ...
        if (recipeName.equals(recipeToFind.getName()) && amountPaid >= recipeToFind.getPrice()) {
            
            Order order = new Order(recipeToFind, customerName, amountPaid);
