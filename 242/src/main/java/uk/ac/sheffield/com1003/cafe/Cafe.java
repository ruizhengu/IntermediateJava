...
The Cafe class represents a cafe that can serve multiple recipes, take orders and print menus.
This class contains methods to add, remove and get the list of available recipes,
place orders, print the full menu, print a list of pending orders, and greet customers.
*/
...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException  {
        ...
        for (int i = 0; i < menu.length && !recipeFound; i++) {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) 
        ...
        // Indicates the order was successfully placed.
        return true;
    }
