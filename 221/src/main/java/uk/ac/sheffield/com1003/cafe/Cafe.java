...
public class Cafe {
    ...
    public void printMenu() {
        ...
        System.out.println(SEPARATOR);
        for (Recipe r: getMenu()) {
            if (r != null) { System.out.println(r.getName() + " - " + r.getPrice()); }
        }
        System.out.println(SEPARATOR);
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        // throws exception if cafe cannot take anymore orders
        if (indexNextOrderToPlace < orders.length) {
            // throws exception if recipe is not found
    ...
    public Order serveOrder() {
        // ensure indexNextOrderToServe is less than indexNextOrderToPlace in case indexNextOrderToPlace increments to 1 over cafe's max capacity
        if (indexNextOrderToServe < indexNextOrderToPlace && orders[indexNextOrderToServe] != null) {
