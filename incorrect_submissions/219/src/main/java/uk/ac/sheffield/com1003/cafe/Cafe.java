...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        int indexOfRecipe = Arrays.asList(menu).indexOf(r);
        menu[indexOfRecipe] = null;
    }
    ...
    public void printMenu() {
        ...
        //For all the recipes in the menu
        for (Recipe r : menu) {
            //Check that recipe is not null
            if(r != null){
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid)
        ...
        //Check if exceeded cafe capacity
        ...
        for (Recipe r : menu){
            ...
            if(r != null && recipeName == r.getName()) {
                //Check that amount paid is sufficient
