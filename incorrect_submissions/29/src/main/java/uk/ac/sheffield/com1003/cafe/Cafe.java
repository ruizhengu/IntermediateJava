...
public class Cafe {
    ...
    public void printPendingOrders() {
        ...
        //Only print order if >= indexNextOrderToServe and the order is not null
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        for (Recipe menuItem: this.getMenu()) {
            if (menuItem != null) {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        //Finds recipe with the name as recipeName, then checks money, then order
    ...
    public Order serveOrder() {
        ...
        //Serve next order if not null, increment indexNextOrderToServe and return previous order
