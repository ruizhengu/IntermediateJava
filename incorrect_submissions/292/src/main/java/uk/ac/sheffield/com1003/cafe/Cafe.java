...
public class Cafe {
    ...
    public void printMenu() {
        ...
        listMenu.add("==========");
        listMenu.add(greeting());
        listMenu.add("Menu");
        listMenu.add("==========");
        listMenu.add(menu[0].getName() + " - " + menu[0].getPrice());
        listMenu.add(menu[1].getName() + " - " + menu[1].getPrice());
        listMenu.add(menu[2].getName() + " - " + menu[2].getPrice());
        listMenu.add("==========");
        listMenu.add("Enjoy!");
    }
