...
public class Cafe {
    ...
    public void printMenu() {
        ...
        // Create a greeting, menuheader and divider
        ...
        System.out.println(divider);
        // Loop through each recipe in the cafe's menu array
        for (Recipe recipe : menu) {
            if (recipe != null) {
                System.out.printf("%s - %.1f\n", recipe.getName(), recipe.getPrice());
            }
        }
