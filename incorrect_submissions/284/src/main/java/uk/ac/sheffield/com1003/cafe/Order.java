...
/**
 * This Class represents an order of a recipe made by a customer.
 */
public class Order {
    ...
    /**
     * @return the date and time that an order was served
     */
     ...
     *         the format "Order: <Recipe name>; For: <Customer name>; Paid: <Amount
     *         paid>"
     */
    @Override
