 ...
 * It methods allow for adding/removing recipes from the menu, placing orders, and printing the menu and pending orders.
...
public class Cafe {
     ...
     */
    public Cafe() {
        this("Cafe", DEFAULT_MENU_SIZE, DEFAULT_CAPACITY);
    }
