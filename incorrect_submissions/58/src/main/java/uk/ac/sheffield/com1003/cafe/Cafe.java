...
public class Cafe {
    ...
    public boolean addRecipe(Recipe newRecipe) {
        ...
        while (i < menu.length && !added) {
            if (menu[i] == null) {
                menu[i] = newRecipe;
                nRecipes++;
                //System.out.println("Added " + newRecipe.getName() + " to the menu");
                added = true;
            } else
                i++;
        }
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        for (int i = 0; i < menu.length; i++) {
            ...
            if (r != null) {
                if (r.getName().equals(recipeName)) {
                    System.out.println("Removed " + r.getName() + " from the menu");
                    menu[i] = null;
        ...
        // If the function reaches this point, no recipe was found
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        if (amountPaid >= recipe.getPrice()) {
            ...
            //System.out.println(customerName + " placed an order for " + recipe.getName());
