...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        //search for the recipe in the menu
    ...
    RecipeNotFoundException, CafeOutOfCapacityException {
    	...
    	//sufficient amount and recipe name existence in menu
    	if (amountPaid < orderedRecipe.getPrice() || orderedRecipe == null) {
    		return false;
    	}
    	
    	//check the cafe is out of capacity
    	if (indexNextOrderToPlace == orders.length) {
    		throw new CafeOutOfCapacityException ();
    	}
    	
    	//creating new order and insert them into array.
