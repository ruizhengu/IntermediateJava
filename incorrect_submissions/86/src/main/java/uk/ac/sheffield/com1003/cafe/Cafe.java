...
public class Cafe {
     ...
     */
    public String greeting() {return "Welcome to " +getName();
    }
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
        // implement solution the task 7 here
     ...
     * ==========
     * Enjoy!
     * for line 138-140 is to find the recipe name and match the price
     */
