...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
        int itemIndex = findRecipeIndex(recipeName);
        if (itemIndex == -1) throw new RecipeNotFoundException();
        menu[itemIndex] = null;
    }
    ...
    public void printPendingOrders() {
        ...
        else System.out.println("No pending orders");
    }
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException{
        ...
        if(order != null){
            ...
            if(order.getPrice() < amountPaid){
                orders[this.indexNextOrderToPlace] = new Order(order, customerName, amountPaid);
