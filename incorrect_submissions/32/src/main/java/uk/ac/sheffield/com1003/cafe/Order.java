...
/**
 * This class represents an order placed in the cafe. The information contained 
 * in an order includes the date and time in which the order was placed, the 
 * name of the customer, a reference to the recipe that has been ordered, the 
 * amount of money paid (in pounds), and possibly the customer’s special 
 * request (e.g., “extra hot”).
 */
...
public class Order {
     ...
     * Served: <Served date and time in format dd-MM-yyyy HH-mm-ss if already 
     * served; otherwise "Pending">
     * Thank you!
     */
     ...
     * the format "Order: <Recipe name>; For: <Customer name>; 
     * Paid: <Amount paid>"
     */
    @Override
    public String toString() {
        return "Order: " + recipeOrdered.getName() + "; For: " + customerName + 
                "; Paid: " + amountPaid;
    }
}
