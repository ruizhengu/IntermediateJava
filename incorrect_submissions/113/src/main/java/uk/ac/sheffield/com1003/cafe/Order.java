...
/**
 * This class handles the specifics of an order, pertaining to what Recipe was ordered, the amount the customer
 * paid for the order and any special requests from the customer while also being able to print a receipt for the order.
 */
public class Order {
