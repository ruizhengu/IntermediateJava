...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        while (i < menu.length && found == false) {
    ...
    public void printPendingOrders() {
        ...
        for (int i = 0;i < this.indexNextOrderToPlace - this.indexNextOrderToServe; i++) {
        	Order curorders = orders[this.indexNextOrderToServe+i];
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException{
    	if (this.indexNextOrderToPlace < orders.length) {
    		Recipe theItem = findRecipe(recipeName);
		    if (findRecipe(recipeName) != null){
		    	if (theItem.getPrice() <= amountPaid ) {
		    		orders[this.indexNextOrderToPlace] = new Order(theItem , customerName, amountPaid);
    ...
    public Order serveOrder() {
        if (orders[this.indexNextOrderToServe] != null) {
        	Order thisorder = orders[this.indexNextOrderToServe];
        	thisorder.serve();
