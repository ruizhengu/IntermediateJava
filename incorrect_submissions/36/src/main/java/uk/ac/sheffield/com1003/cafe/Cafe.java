...
public class Cafe {
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        Recipe[] menu = getMenu(); // Call getMenu() method to get menu array
        // Print each recipe
        for (int i =0; i < menu.length; i++){
    ...
    public boolean placeOrder (String recipeName, String customerName, double amountPaid)  throws
       ...
       // Initialize indexNextOrderToPlace
        indexNextOrderToPlace = 0;

        // Find recipe from recipe list
    ...
    public Order serveOrder() {
        // Initialize indexNextOrderToServe
        indexNextOrderToServe = 0;
        
        // Check if there is an order to serve
        if (this.indexNextOrderToServe < this.indexNextOrderToPlace) {
            // Serve order
