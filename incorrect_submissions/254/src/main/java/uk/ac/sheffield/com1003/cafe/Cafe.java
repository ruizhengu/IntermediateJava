...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        int i = 0; // count iterations of the loop
        while (!recipeFound && i < menu.length) {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, 
        ...
        /* find the recipe in the menu, if it does not exist then givenRecipe will remain null */
        Recipe givenRecipe = null;
        for (Recipe recipe : menu) {
        ...
        /* throw exception if the orders are full */
