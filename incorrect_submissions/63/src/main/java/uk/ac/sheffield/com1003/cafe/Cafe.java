...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        for (int i = 0; i < len; i++) {
            ...
            Recipe afterDelete = menu[len - 1];
            if (Objects.nonNull(menuRecipe) && Objects.equals(recipeName, menuRecipe.getName())) {
                flag  = true;
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid)
        ...
        if (Objects.requireNonNull(findRecipe(recipeName)).getPrice()==amountPaid){
            return true;
        }
        return false;
    }
