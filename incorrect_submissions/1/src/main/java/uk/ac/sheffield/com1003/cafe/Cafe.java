...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        //If recipe doesn't exist throw RecipeNotFoundException
        if (recipeToRemove == null) {
            throw new RecipeNotFoundException();
        }

        // Remove the recipe by setting the corresponding element to null
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        // Find the recipe with the given name in the cafe's menu.
        Recipe recipe = null;
        ...
        // Throw an exception if the recipe is not found in the menu.
        if (recipe == null) {
            throw new RecipeNotFoundException();

        }

        // Throw an exception if the cafe has reached its maximum capacity for orders.
        if (indexNextOrderToPlace >= orders.length ) {
            throw new CafeOutOfCapacityException();

        }
        // Place the order if the amount paid is sufficient, and update the next available index for placing orders.
