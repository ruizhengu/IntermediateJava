...
public class Cafe {
    ...
    /**
    *Removes a recipe from the menu with the given recipe namee.
    *@param recipeName the name of the recipe to be removed
    *@throws RecipeNotFoundException if the recipe is not found in the menu
    */
    ...
    /**
    *Returns the recipe with the given recipe name from the menu.
    *@param recipeName the name of the recipe to find
    *@return the recipe with the given recipe name, or null if the recipe does not exist in the menu
    */
    ...
    /**
     * Serves the next pending order and returns it
