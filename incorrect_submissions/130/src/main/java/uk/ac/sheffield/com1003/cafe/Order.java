...
public class Order {
    ...
    public boolean equals(Recipe r1, Recipe r2) {
        //first check if r1 or r2 is null.
        if (r1 == null || r2 == null) return false;

        //check for name.
        if (!r1.getName().equals(r2.getName())) return false;

        //check for price.
        if (r1.getPrice() != r2.getPrice()) return false;

        // creating two arrays to get ingredients.
        Ingredient[] ingredientR1 = r1.getIngredients();
        Ingredient[] ingredientR2 = r1.getIngredients();

        if (!Arrays.equals(ingredientR1, ingredientR2)) return false;
