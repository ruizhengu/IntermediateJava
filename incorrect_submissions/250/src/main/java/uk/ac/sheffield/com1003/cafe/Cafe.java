...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        while (i < menu.length) {
            ...
            // Checks if a recipe exists at index i and its name matches recipeName
        ...
        // Checks if a recipe index was found, recipeIndex is non zero
        if (recipeIndex >= 0) {
    ...
    public void printMenu() {
        ...
        // Loops through recipes in menu
        for (Recipe recipe: menu) {

            // Checkeds if recipe is not empty in menu
            if (recipe != null) {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws CafeOutOfCapacityException, RecipeNotFoundException {
        ...
        if (amountPaid >= recipe.getPrice()) {
            Order newOrder = new Order(recipe, customerName, amountPaid);
    ...
    public Order serveOrder() throws CafeOutOfCapacityException {
        ...
        // Checks whether there is an order which already needs serving 
