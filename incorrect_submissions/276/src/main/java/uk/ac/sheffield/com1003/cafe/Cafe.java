...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        // Search for the index of the recipe with the given name in the menu array
        int recipeIndex = -1;
        ...
        // Set the last element of the menu array (which is now a duplicate of the
        // second-last element) to null, and decrement the recipe count
    ...
    public Order serveOrder() {
        if (indexNextOrderToServe >= nOrders) {
            return null;
        }
