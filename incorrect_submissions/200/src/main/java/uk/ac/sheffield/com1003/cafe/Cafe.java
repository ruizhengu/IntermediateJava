...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        while (i < menu.length && !deleted) {
            ...
            if(menu[i].getName() == recipeName){
                ...
                nRecipes--;
                deleted = true;
                //move all recipes after the deleted one, up one
    ...
    public void printPendingOrders() {
        ...
        for(int i = 0; i < (indexNextOrderToPlace-indexNextOrderToServe); i++){
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        Recipe[] currentMenu = this.getMenu();
    ...
    public Order serveOrder() {
        ...
        if(indexNextOrderToPlace >= 1 && indexNextOrderToServe<=orders.length){
            orders[indexNextOrderToServe].serve();
            orders[indexNextOrderToServe].toString();
