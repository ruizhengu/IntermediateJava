...
public class Cafe extends TooManyIngredientsException {
    private String name;
    private Recipe[] menu;
    ...
    public void printMenu() {
        ...
        // Loops through all items in the menu, printing out the name and price of every item
        for (int i = 0; i < menu.length; i++) {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) {
        ...
        for (int i = 0; i < this.menu.length; i++) {
            if (this.menu[i].getName() == recipeName) {
                recipeExists = true;
                if (amountPaid >= this.menu[i].getPrice()) {
                    return true;
                }
            }
        }
