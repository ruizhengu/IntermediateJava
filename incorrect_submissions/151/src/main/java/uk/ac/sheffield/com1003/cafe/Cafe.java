...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        if(this.findRecipe(recipeName) == null   /*throw wrong recipeName in Exception*/

        ){throw new RecipeNotFoundException();

        }
        for(int i = 0; i < menu.length ; i++) {
            if (menu[i] == this.findRecipe(recipeName)) {
                menu[i] = null;
            }
        }
    }
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws CafeOutOfCapacityException, RecipeNotFoundException {
       if (indexNextOrderToPlace > orders.length - 1){
             throw new CafeOutOfCapacityException();       /*if can't add throw in CafeOutOfCapacityException*/
       } else if (findRecipe(recipeName) == null) {      /*throw wrong name in RecipeNotFoundException*/
           throw new RecipeNotFoundException();
       }
