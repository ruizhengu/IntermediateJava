...
public class Cafe {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
    	...
    	/**
    	 * The exception thrown if the next order is over the order limit
    	 */
    	if (indexNextOrderToPlace >= orders.length)
			throw new CafeOutOfCapacityException();
    	
    	/**
    	 * The exception thrown if the recipe does not exist
    	 */
    	if (recipe == null)
    			throw new RecipeNotFoundException();
    	
    	if (recipeName == recipe.getName() && amountPaid >= recipe.getPrice() && recipe != null) {
    ...
    public Order serveOrder() {
    	Order servingOrder = orders[indexNextOrderToServe];
    	if (orders != null) {
