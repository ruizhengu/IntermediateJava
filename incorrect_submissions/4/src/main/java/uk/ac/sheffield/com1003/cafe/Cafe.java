...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
        if (this.findRecipe(recipeName) != null) {
            for (int i = 0; i < menu.length; i++) {
                // Only remove the recipe if it is not null and decrease number of recipes
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        // Loops through menu and prints each recipe name and price, skipping empty/null recipes
        for (int i = 0; i < menu.length; i++) {
            if (menu[i]!= null) {
