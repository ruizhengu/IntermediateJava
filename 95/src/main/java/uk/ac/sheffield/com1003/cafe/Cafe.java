...
/**
 * Cafe class representing a cafe.
 * This class holds information about a cafe's name, menu, orders, and the number of recipes.
 * It also has functions to add/remove recipes, print pending orders and the full menu, serve orders and find recipes.
 */
public class Cafe {
    private String name;
    private Recipe[] menu;
    ...
    public void printPendingOrders() {
        ...
        for ( int i = 0; i < indexNextOrderToPlace; i++ ) {
            ...
            if ( orders[i].getOrderServed() == null ) {
    ...
    public void printMenu() {
        ...
        //Loop to print out the items and their prices
        for ( Recipe menu : getMenu() ) {
    ...
    public boolean placeOrder ( String recipeName, String customerName, double amountPaid ) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        //Check if the ordered recipe exists
        if ( findRecipe ( recipeName ) == null )
        ...
        else if ( findRecipe ( recipeName ).getPrice() > amountPaid )
