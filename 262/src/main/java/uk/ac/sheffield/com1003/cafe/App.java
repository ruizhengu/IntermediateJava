...
public class App {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("This recipe was not found: "+ e.getRecipe());
		} catch (CafeOutOfCapacityException e) {
			System.out.println("Cafe has maximum capacity of "+ e.getMaxNumOfItems() + " orders");
			System.out.println("There has been  "+ e.getIndexOfCurrentItem()+ " orders");
		} catch (TooManyIngredientsException e)	{
			System.out.println("Max number of ingredients allowed is:  " + e.getMaxNumIngredients());
			System.out.println("Number of ingredients in your recipe:  " + e.getNumIngredients());
		}
