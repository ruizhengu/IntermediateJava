...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
    	for (int i = 0; i < menu.length; i++) {
			...
			// Check recipe exists at index and it is the right one
    ...
    public void printPendingOrders() {
    	...
    	// End before index of next to be placed as know rest will be null
