...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        /*The below for loop will go through menu checking for matching recipes
         * If a recipe is found it is removed from menu
         */
    ...
    throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        return this.placeOrder(recipeName,customerName,amountPaid,null);
    }

    /**
     * Place an order for a given recipe name with a given amount of money and specia.
     * 
     * @param recipeName The name of the recipe being ordered
     * @param amountPaid Money handed when placing order
     * @param customerName Name of customer placing order
     * @param specialRequest Request of customer placing order
     * @return True if the recipe name exists in the menu and the amount paid is sufficcient; return false otherwise
     * @throws RecipeNotFoundException if the recipe name does not exist in the menu
     * @throws CafeOutOfCapacityException if the cafe cannot take any more orders and is out of capacity
     */
    ...
    public Order serveOrder() {
        ...
        /*If the serve pointer is greater than or equal to place pointer
        * then there is no placed orders left to serve
        */
