...
/** 
 * Represents a cafe that handles
 * {@link Order}s and {@link Recipe}s
*/
public class Cafe {
    private String name;
    private Recipe[] menu;
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        //Swaps removed recipe with recipe at end of the list to ensure list remains unbroken
    ...
    public void printPendingOrders() {
        ...
        if (!printedOrder) {
            System.out.println("No currently pending orders.");
        }
    }
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        Recipe recipeToMake = this.findRecipe(recipeName);
        if(recipeToMake == null){
            throw new RecipeNotFoundException();
        }
        if(indexNextOrderToPlace < orders.length){
            orders[indexNextOrderToPlace] = new Order(recipeToMake,customerName,amountPaid);
