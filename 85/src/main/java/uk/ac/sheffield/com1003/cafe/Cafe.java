...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        Recipe recipeToDelete = findRecipe(recipeName);
        if(recipeToDelete == null) throw new RecipeNotFoundException();
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        if(this.indexNextOrderToPlace >= this.orders.length) throw new CafeOutOfCapacityException();

        if(amountPaid < recipe.getPrice()) return false;

        this.orders[indexNextOrderToPlace] = new Order(recipe, customerName, amountPaid);
    ...
    public Order serveOrder() {
        Order orderToServe = orders[this.indexNextOrderToServe];
        if(orderToServe == null) return null;
