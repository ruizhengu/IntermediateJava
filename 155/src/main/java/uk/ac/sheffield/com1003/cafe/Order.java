...
/**
 * Represents an order at a cafe. Contains information about the recipe ordered,
 * the customer who placed the order, the amount paid, the special request (if any),
 * and the date and time the order was placed and served.
 */
public class Order {
