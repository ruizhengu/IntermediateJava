...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
    	//Check whether recipe exists in menu
    	Recipe m = findRecipe(recipeName);
        if (m == null)
        	throw new RecipeNotFoundException();
        //loop through menu, decreasing index of all elements after the recipe to be removed
        boolean found = false;
        for (int i = 0; i < nRecipes-1; i++) {
        	if (menu[i] == m) {
        		found = true;
        	}
        	if (found) {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        //if recipe cannot be found in menu
        if (recipe == null)
        	throw new RecipeNotFoundException();
        //if the orders array will overflow
    ...
    public Order serveOrder() throws CafeOutOfCapacityException {
        ...
        //increment next counter and return order
