...
public class Cafe {
    ...
    public Order serveOrder() {
        if (orders[indexNextOrderToServe] == null) {
            System.out.println("There are no orders to serve");
            return null;
        }
        else {
            /* remove the order, increment the indexNextOrderToServe pointer,
             * so it points at the new next order to serve in the array.
             */
