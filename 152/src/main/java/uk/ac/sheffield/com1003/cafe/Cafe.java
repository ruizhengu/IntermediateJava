...
public class Cafe {
    ...
    public boolean addRecipe(Recipe newRecipe) {
        ...
        while (i < menu.length && !added) {
            if (this.menu[i] == null) {
                this.menu[i] = newRecipe;
                this.nRecipes++;
                this.indexNextOrderToPlace = i+1;
                added = true;
            } else
                i++;
        }
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        int position = 0;
        while (position < (this.indexNextOrderToPlace)) {
            System.out.print(this.menu[position].getName());
            System.out.print(" - ");
            System.out.println(this.menu[position].getPrice());
            position+=1;
        }
        System.out.println("==========");
