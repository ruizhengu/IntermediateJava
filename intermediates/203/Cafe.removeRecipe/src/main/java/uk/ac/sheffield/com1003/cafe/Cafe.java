...
public class Cafe {
     ...
     */
    public String greeting() { // sets of welcome greeting 
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        if(this.findRecipe(recipeName) != null) // checks if recipe name is there on the menu
        {
            for (int i = 0; i < menu.length; i++) {
                if (menu[i].getName() == this.findRecipe(recipeName).getName()){
                    menu[i] = null; // removes form array
                }
            }
