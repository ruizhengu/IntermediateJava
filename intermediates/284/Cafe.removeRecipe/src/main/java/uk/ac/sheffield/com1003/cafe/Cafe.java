...
/**
 * Cafe class represents a cafe that can manage a menu of recipes and take
 * orders from customers.
 * Recipes can be added to the menu, and orders can be placed for those recipes.
 * The cafe can also remove recipes from the menu, print the full menu and print
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        if (findRecipe(recipeName) != null) {
            for (int i = 0; i < menu.length; i++) {
                ...
                // searching the menu for the given recipe
