...
public class Cafe {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException,
    	...
    	// Stores recipe object of recipeName
    	Recipe tempRecipe = findRecipe(recipeName);
    	// Checks the requirements for a successful order are met
    	if (indexNextOrderToPlace < orders.length) {
    		if (tempRecipe != null) {
    			if (amountPaid >= tempRecipe.getPrice()) {
    				orders[indexNextOrderToPlace] = new Order(tempRecipe, customerName, amountPaid);
    	...
    	else throw new CafeOutOfCapacityException();
