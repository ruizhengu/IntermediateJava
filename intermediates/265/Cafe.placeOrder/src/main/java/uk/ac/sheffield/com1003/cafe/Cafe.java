...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
        ...
        if(findRecipe(recipeName) == null){
            ...
            Recipe toBeRemoved = findRecipe(recipeName);
            Recipe[] newMenu = new Recipe[nRecipes - 1];
            for(int i = 0, k =0; i < nRecipes; i++){
                if(!menu[i].equals(toBeRemoved)) {
                    newMenu[k] = menu[i];
                    k++;
                }
            }
    ...
    public boolean placeOrder(String recipeName, String customerName,
        ...
        if(recipe == null){
            ...
            if(amountPaid >= recipe.getPrice()){
                orders[indexNextOrderToPlace] = new Order(recipe, customerName,
                        amountPaid);
