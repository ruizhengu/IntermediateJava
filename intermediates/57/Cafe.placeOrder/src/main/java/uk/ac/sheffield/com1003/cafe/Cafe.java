...
public class Cafe {
    ...
    public void printMenu() {
        ...
        Recipe[] cafeMenu = getMenu();

        System.out.println("==========");
        System.out.println(greeting());
        System.out.println("Menu");
        System.out.println("==========");
        //Print each item on menu's name and price
        for (int i = 0; i < cafeMenu.length; i++) {
            System.out.println(cafeMenu[i].getName() + " - " + cafeMenu[i].getPrice());
        }
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid)
        ...
        //Add recipe to order list
        else {
            Order nextOrder = new Order(orderRecipe, customerName, amountPaid, null);
