...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        if (findRecipe(recipeName) != null){
            ...
            if (index != -1) {
                ...
                for (int i = 0, k = 0; i < menu.length; i++) {
                    if (i == index) {
                        continue;
                    }
                    newMenu[k++] = menu[i];
    ...
    public void printPendingOrders() {
        ...
        /*System.out.println(indexNextOrderToPlace);
    ...
    public void printMenu() {
        ...
        //run through all recipes in the cafe menu using for loop and sizeMenu
        //output recipe name and recipe price on same line
