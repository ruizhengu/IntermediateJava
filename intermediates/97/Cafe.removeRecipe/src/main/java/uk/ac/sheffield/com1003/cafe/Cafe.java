...
public class Cafe {
     ...
     * @throws RecipeNotFoundException if recipe does not exist in the menu
     */
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        // Implement solution to task 7 here
    	
    	int removedIndex = 0;
    	boolean recipeOnMenu = false;
    	
    	for (int i=0; i < menu.length; i++) {
    		if (menu[i] != null && menu[i] == findRecipe(recipeName)) {
    			recipeOnMenu = true;
    			removedIndex = i;
    			
    			//removes the recipe and shifts all the elements to the left to fill in the gap
    			
    			while (menu[removedIndex] != null) {
    				menu[removedIndex] = menu[removedIndex + 1];
    				removedIndex++;
    			}
    		}
    	}
    	
    	if (recipeOnMenu == false)
