...
public class Cafe {
     ...
     * If recipe does not exist exception thrown
     * Sets position in menu array to null and decreases nRecipes by 1
     ...
     * Menu
     * ==========
     * (Iterates through menuArray here)
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        Recipe [] menuArray = this.getMenu();
        for (int i = 0; i<menuArray.length; i++){
            System.out.print(menuArray[i].getName());
            System.out.print(" - ");
            System.out.println(menuArray[i].getPrice());
        }
        System.out.println("==========");
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        Recipe [] menuArray = this.getMenu();
        for (int i = 0; i < menuArray.length; i++){
            if (menuArray[i].getName() == recipeName){
            orders[indexNextOrderToPlace] = new Order(menuArray[i], customerName, amountPaid);
