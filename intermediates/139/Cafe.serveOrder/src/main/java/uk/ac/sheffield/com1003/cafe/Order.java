...
public class Order {
    ...
    /**
     * Returns the served status of an order.
     * 
     * If an order is served (ie if @orderServed is not null), returns true
     * Otherwise returns false
     * 
     * @return Boolean - served or not
     */
    public boolean isServed() {
    	boolean served = false; 
    	if (this.orderServed != null) {
    		served = true;
    	}
    	return served;
    }
