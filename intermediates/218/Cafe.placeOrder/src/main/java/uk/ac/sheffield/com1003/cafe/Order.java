...
public class Order {
    ...
    /**
     * Updates field {@link Order#orderServed} with the current local time and date 
     */
    public void serve() {
        this.orderServed = LocalDateTime.now();
    }
/**
 * Returns the local date and time the order was served.
 *
 * @return The local date and time the order was served.
 */
    public LocalDateTime servedOrders() {
        return orderServed; 
    }
