/**
 * Order.java
 * The Order class contains fields and methods to represent a customer order for a recipe.
 * This includes customer information, special requests, amount paid.
 * It also includes order placement and serving time, and printing receipts.
