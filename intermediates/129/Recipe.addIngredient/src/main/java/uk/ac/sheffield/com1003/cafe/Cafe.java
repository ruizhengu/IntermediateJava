...
public class Cafe {
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        for (Recipe item : menuItems){
            System.out.println(item.getName()+ " - " + item.getPrice());
            //test in case there is a null
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        //RecipeNotFoundException creation checking if the recipe is in the array
        ...
        //CafeOutOfCapacityException creation
