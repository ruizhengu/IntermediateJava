...
public class Cafe {
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        for (Recipe thisRecipe : getMenu())
            System.out.println(thisRecipe.getName() + " - " + thisRecipe.getPrice());
        System.out.println("==========");
    ...
    {
        // Check if there is space to add a new order
        ...
        //Check amount paid is sufficient
    ...
    public Order serveOrder() {
        // Check if no orders left to serve
        if (indexNextOrderToServe >= indexNextOrderToPlace)
            return null;

        // Serve order and return it
