...
public class Order  {
    ...
    private Recipe recipeOrdered = new Recipe("Espresso", 3, Recipe.Size.SMALL, 1);
    private String CustomerName= new String("Jose");
    private double AmountPaid =3.0;
...
//    private Recipe recipeOrdered;
    ...
    public Order(Recipe recipeOrdered, int numOrdered) {
   ...
   public Order(){}
    ...
    public Recipe getRecipe() {return recipeOrdered;
    }
}