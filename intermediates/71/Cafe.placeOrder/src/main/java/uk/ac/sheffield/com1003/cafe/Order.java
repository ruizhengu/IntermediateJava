...
public class Order {
    ...
    public void printReceipt() {
        ...
        sb.append(lineBreak);
        sb.append("Served: ");
        if (getOrderServed() == null) 
            sb.append("Pending");
        else
            sb.append(getOrderServed().format(formatter));
        sb.append("Thank you!");
	...
	/**
	 * @return Returns the date the order was served, or null if it has not yet been served. This was necessary so that 'printPendingOrders' would 
	 * not print orders that had already been served.
	 */
