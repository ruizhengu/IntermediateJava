...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        ...
        // If recipe name has not been found
        if (! recipeExists)
    ...
    public void printPendingOrders() {
        ...
        // Repeat for number of orders serving is behind placing
    ...
    public void printMenu() {
        ...
        System.out.println("==========");
        // Repeat for number of valid recipes on the menu
        for (int i = 0; i < getMenu().length; i++) {
            System.out.print(getMenu()[i].getName());
            System.out.print(" - ");
            System.out.println(getMenu()[i].getPrice());
        }
        System.out.println("==========");
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid)
        ...
        if (indexNextOrderToPlace < orders.length) {
            // If cafe has capacity for order
