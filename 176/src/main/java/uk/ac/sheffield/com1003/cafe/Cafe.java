...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException {
        if (findRecipe(recipeName) == null)
            ...
            for (int i = 0; i < menu.length; i++) {
                if(menu[i].getName().equals(findRecipe(recipeName).getName())) {
                    menu[i] = null;
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws CafeOutOfCapacityException,
        ...
        if (indexNextOrderToPlace >= orders.length)
            ...
            if (amountPaid >= findRecipe(recipeName).getPrice()){
                ...
                System.out.println("Sorry, the amount paid is insufficient");
        }
        return false;
    }
    ...
    public Order serveOrder() {
        if (indexNextOrderToServe < indexNextOrderToPlace) {
            ...
            System.out.println("There is no order to serve");
            return null;
        }
    }
}
