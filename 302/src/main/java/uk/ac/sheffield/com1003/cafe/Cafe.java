...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
        ...
        for (int i = 0; i < nRecipes; i++) {
            if (menu[i] == recipeMoved) {
                for (int k = i; k < nRecipes - 1; k++) {
                    menu[k] = menu[k+1];
                }
    ...
    public void printMenu() {
        ...
        for (int i =0; i < this.getMenu().length; i++) {
            System.out.print(this.getMenu()[i].getName());
            System.out.print( " - ");
            System.out.println(this.getMenu()[i].getPrice());
        }
        System.out.println("==========");
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException{
        ...
        Order orderPlace = new Order(recipe, customerName, amountPaid);
        orders[indexNextOrderToPlace] = orderPlace;
