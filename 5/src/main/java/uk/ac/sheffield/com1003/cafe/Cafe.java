...
public class Cafe {
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException, CafeOutOfCapacityException {
        ...
        Recipe recipeToOrder = findRecipe(recipeName);
        Order orderToPlace = new Order(recipeToOrder, customerName, amountPaid);
        ...
        if (amountPaid < recipeToOrder.getPrice())
            return false;

        orders[indexNextOrderToPlace] = orderToPlace;
