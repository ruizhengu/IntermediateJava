...
public class Cafe {
    ...
    /**
     Checks whether the given string is a valid name. A valid name is not null and not empty after trimming white spaces.
     @param name the string to be checked to see if exists
    ...
    /**
    /**
     * Returns the recipe with the specified name from the menu, or null if no such recipe exists.
     *
     * @param recipeName the name of the recipe to retrieve
     * @return the Recipe object with the specified name, or null if no such recipe exists
     */
    ...
    public boolean placeOrder(String recipeName, String customerName, double amountPaid) throws RecipeNotFoundException,
            CafeOutOfCapacityException {
                ...
                if (!isAValidName(customerName)) {
                    return false; // invalid customer name
                }

                if (amountPaid < recipe.getPrice()){
                    return false; // amount paid is insufficient
                }
                double change = amountPaid - recipe.getPrice();
                if (change >= 0) {
    ...
    public Order serveOrder() {
        ...
        orders[indexNextOrderToPlace - 1] = null;
        indexNextOrderToPlace--;
        return orderToServe;
    }
}
