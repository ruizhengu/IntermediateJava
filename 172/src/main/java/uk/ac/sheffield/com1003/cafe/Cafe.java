...
public class Cafe {
    ...
    public void removeRecipe (String recipeName) throws RecipeNotFoundException {
        ...
        while (i < menu.length && !found) {
            if ( (menu[i] != null) &&  menu[i].getName().equals(recipeName) ) {
                ...
                // shifting recipe objects after deleting and remove last duplicate
    ...
    //Task 4, print pending orders while iterating through object array
    public void printPendingOrders() {
        ...
        for(int i=0;i<orders.length;i++) {
            ...
            if(orders[i].getOrderServed() == null && orders[i] != null){
     ...
     */
     ...
     //task2 PrintMenu message made using testcase
