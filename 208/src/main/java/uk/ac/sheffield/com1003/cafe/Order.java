 ...
 * It has attributes for the ordered recipe, the customer's name, the amount paid, special requests,
 * the time time the order was placed and the time it was served.
 */
public class Order {
