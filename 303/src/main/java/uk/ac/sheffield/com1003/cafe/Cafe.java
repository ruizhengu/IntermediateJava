...
public class Cafe {
    ...
    public void removeRecipe(String recipeName) throws RecipeNotFoundException{
        ...
        int arrayLimit = getMenu().length ; 
            ...
            System.out.println("Recipe " +recipeName +" has been removed");
       }
    }
               ...
               if(findRecipe(recipeName)==null){
                    ...
                    if(findRecipe(recipeName).getPrice()<=amountPaid){ 
                        if(indexNextOrderToPlace< orders.length){
                          ...
                          //  System.out.println("The order: "+ recipeName + " has been placed!"); 
                          // when add this message, the test for printPending fails
                            indexNextOrderToPlace++ ;
                            return true ;
                        }else{
                            throw new CafeOutOfCapacityException() ; }
                    }else{
                        System.out.println("Sorry you don't have enough of money.");
                        return false ;}
                 }
    ...
    public Order serveOrder() {
        if(indexNextOrderToPlace == indexNextOrderToServe){
            System.out.println("No order to Serve. Try to place an order first!");
            return null ; }
        else{
            orders[indexNextOrderToServe].serve();
            indexNextOrderToServe++ ;
            orders[indexNextOrderToServe-1].printReceipt();
